...
//////////////////////////////////////////////////////////////////
   ...
   //config_descriptor for config index 1
         ...
         //0x80,                      //bit 6=0 if bus powered, bit 5=0 if doesn't supports remote wakeup, bits 0-4 reserved and bit7=1
         0x64,                      //maximum bus power required (maximum milliamperes/2) = n° HEX  (0x32 = 100mA)
