...
#include <usb.h>
   ...
   const char USB_CLASS_SPECIFIC_DESC[] = {
      ...
      0x95, PACK,     // Report count 
                      // Como Report size = 8 bits = 1 byte, y Report Count = PACK = 32,
                      // entonces: Report Count * Report Size = 32 bytes.
      0x81, 2,        // Input (Data, Var, Abs) Input significa que el Device enviará este paquete
      0x19, 1,        // Usage minimum
      0x29, 8,        // Usage maximum
      0x75, 8,        // Report size = 8 (bits)
      0x95, PACK,     // Report count
                      // Como Report size = 8 bits = 1 byte, y Report Count = PACK = 32,
                      // entonces: Report Count * Report Size = 32 bytes.
      0x91, 2,        // Output (Data, Var, Abs) Output significa que la PC enviará este paquete
      0xc0            // End Collection
   };
   ...
   //config 1
      //interface 0
         33       //tamaño del reporte HID en bytes
   };
